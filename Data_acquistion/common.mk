...
ARENA_SDK_PATH ?= /home/berg/ArenaSDK_Linux_ARM64
...
LDFLAGS = -L$(ARENA_SDK_PATH)/lib \
          -L$(ARENA_SDK_PATH)/GenICam/library/lib/Linux64_ARM \
          -L../../../ffmpeg \
          $(OPENCV_LIB_PATH)
...
INCLUDE= -I$(ARENA_SDK_PATH)/include/Arena \
         -I$(ARENA_SDK_PATH)/include/Save \
         -I$(ARENA_SDK_PATH)/include/GenTL \
         -I$(ARENA_SDK_PATH)/GenICam/library/CPP/include \
		 $(OPENCV_INC_PATH)
