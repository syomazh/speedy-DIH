...
zf_values = list(range(60000, 70001, 50))    # Continue the list in steps of 2000 up to 200000
zf_hologram_values = HelperFunctions.generate_intervals(65830, 500, 5)  # Generate intervals around 65000 with a step of 2000 
